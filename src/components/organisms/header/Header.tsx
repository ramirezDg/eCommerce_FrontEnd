  ...
  return (
    <header className='bg-white text-white py-2 px-10'>
      <div className='container mx-auto flex justify-around items-center'>
        <h1 className='text-xl font-bold text-zinc-800'>{PAGE_NAME}</h1>
        <div>
          <div className='relative mt-2 rounded-md shadow-sm'>
            ...
            <input
              ...
              name='search'
              id='search'
              className='block rounded-md border-none pl-7 py-3.5 w-96 text-gray-900 bg-zinc-100 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-gray-600 sm:text-sm sm:leading-6'
              placeholder='Search...'
            />
          </div>
        </div>
